...
class BotConfig(BotConfigMixin):
    ...
    name: str = "NMZ Prayer Flick Runner"
    ...
    def main_loop(self):
        ...
        while True:
            ...
            sleep_duration = random.uniform(
                self.cfg.prayer_flick_delay.value.min_value,
                self.cfg.prayer_flick_delay.value.max_value
            )
            self.wait_interruptible(sleep_duration)
